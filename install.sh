...
# Color del saludo: un preset (off/white/warm/blue/green/red/yellow) o un HEX (#00c853)
POI_LED_PRESET=green
# breathe = el color respira (se atenúa y enciende suave); solid = fijo
POI_LED_MODE=breathe
POI_LED_SECONDS=10
